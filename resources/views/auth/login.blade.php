...
<html lang="en">
	...
	<head>
		...
		<title>NND Admin | Login</title>
		<meta name="description" content="NND Admin">
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
					...
					<div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside" style="background-image: url({{ asset('/admin/assets/media/bg/bg-4.jpg') }});">
						<div class="kt-grid__item">
							<a href="#" class="kt-login__logo">
								<img style="margin:0 auto;" src="{{ asset('admin/assets/media/logos/logo-4.png') }}">
							</a>
						</div>
						<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver">
							<div class="kt-grid__item kt-grid__item--middle">
								<h3 class="kt-login__title">Welcome to NND Admin!</h3>
								<h4 class="kt-login__subtitle">The ultimate NND Admin backend.</h4>
							</div>
						</div>
						<div class="kt-grid__item">
						...
						<div class="kt-login__body">
							...
							<div class="kt-login__form">
								...
								<form class="kt-form" action="{{ url('/login') }}" novalidate="novalidate" id="kt_login_form" method="post">
									...
									<div class="kt-login__actions">
										<a href="javascript:;" class="kt-link kt-login__link-forgot" id="kt_login_forgot">
											Forgot Password ?
										</a>
							...
							<div class="kt-login__forgot">
									...
									<form class="kt-form" action="{{ url('/admin/forgot-password') }}" method="post">
										...
										<div class="kt-login__actions">
											<button id="kt_login_forgot_submit" class="btn btn-primary btn-elevate kt-login__btn-primary">Request</button>&nbsp;&nbsp;
		...
		<script src="{{ asset('front/assets/js/pages/custom/login/login-1.js') }}" type="text/javascript"></script>
