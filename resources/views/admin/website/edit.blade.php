...
<div class="kt-subheader__breadcrumbs">
    ...
    <a href="{{ url('admin/website') }}" class="kt-subheader__breadcrumbs-link">{{VIEW_INFO['title']}}</a>
    <span class="kt-subheader__breadcrumbs-separator"></span>
                ...
                <div class="kt-portlet">
                        ...
                        <form id="frmAddEdit" name="frmAddEdit" action="{{ url(VIEW_INFO['url'].'/edit/'.$data->id) }}" class="form-horizontal" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="kt-portlet__body">
                                ...
                                <div class="form-group">
                                    <label>Website<span class="required"><code>*</code></span></label>
                                    <input type="text" id="website" name="website" data-toggle="tooltip" title="Enter Website"
                                        class="form-control" placeholder="Enter Website" value="{{ $data->website }}" />
                                </div>
                                <div class="form-group">
                                ...
                                <!-- <div class="form-group">
                                    <label>Designation<span class="required"><code>*</code></span></label>
                                    <div>
                                        <select name="designation_id" id="designation_id" class="form-control" >
                                            <option value="">-Select Designation-</option>
                                                @if(isset($arrDesignation) && !empty($arrDesignation))
                                                    @foreach($arrDesignation as $key=>$val)
                                                    <option value="{{ $val->id }}" {{ $data->designation_id == $val->id ? 'selected' : '' }} >{{ $val->name }}</option>
                                                    @endforeach
                                                @endif
                                        </select>
                                    </div>
...
@section('metronic_js')
<script src="{{ asset('admin/assets/js/pages/custom/website.js') }}"></script>
@stop